...
export default function Navbar() {
  ...
  return (<div className="shadow-2xl bg-white pb-4 md:p-0 w-103 md:w-auto ">
    <nav className="flex  px-[2%]  items-center justify-between p-3  ">
      ...
      {/* Center - Search Bar */}
      <div className="hidden md:flex items-center bg-gray-800 px-4 py-2 rounded-full w-full md:w-auto mt-2 md:mt-0">
